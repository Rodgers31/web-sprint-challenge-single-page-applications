...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   React's useRouteMatch is used when using Routes so that the programmer can have acces to its match data.
2. How would you explain form validation to someone who has never programmed before?
   Validation is a series of code used to make sure a user a filing out a form correctly to avoid spam or invalid inputs like not putting a phone number or an email in a form.

3. In 1-2 sentences, define end to end testing.
   A series of test used to test our code to make sure everthing works and does what it's intended to do. Can also be used to catch hudden bugs within our code.
